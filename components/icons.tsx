...
export const ArchiveBoxIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.125 0 1.131.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5m-7.5 0-1 3m1-3 1 3m0 0 .5 1.5m-.5-1.5-.5 1.5m0 0h3.134c1.193 0 2.175.936 2.175 2.086V13.5A2.25 2.25 0 0 1 18 15.75h-1.5a2.25 2.25 0 0 1-2.25-2.25V10.5m0 0h-3.134a2.176 2.176 0 0 0-2.175 2.086V13.5A2.25 2.25 0 0 0 6 15.75h-1.5a2.25 2.25 0 0 0-2.25-2.25V10.5" />
    </svg>
);
...
export const CubeIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 16.811V7.189a1.875 1.875 0 00-1.242-1.764l-6.364-3.692a1.875 1.875 0 00-1.802 0l-6.364 3.692A1.875 1.875 0 003 7.189v9.622a1.875 1.875 0 001.242 1.764l6.364 3.692a1.875 1.875 0 001.802 0l6.364-3.692A1.875 1.875 0 0021 16.811z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 8.25l7.5 4.33 7.5-4.33M3.75 15.75l7.5-4.33 7.5 4.33M12 21.75V12.75" />
    </svg>
);
