...
export const PARAM_CONFIG: ParamConfigGroups = {
  ...
  "Warp Grills (Upper)": {
    ...
    nacelle_grill_length_scale: { label: "Length", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelle_grill_width_scale: { label: "Width", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelle_grill_depth_scale: { label: "Depth", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelle_grill_borderRadius: { label: "Border Radius", min: 0, max: 0.5, step: 0.01, type: 'slider' },
    nacelle_grill_y_offset: { label: "Fore/Aft Offset", min: -10, max: 10, step: 0.1, type: 'slider' },
    nacelle_grill_z_offset: { label: "Vertical Offset", min: -5, max: 5, step: 0.1, type: 'slider' },
    nacelle_grill_spread_offset: { label: "Spread Offset", min: -5, max: 5, step: 0.1, type: 'slider' },
    nacelle_grill_rotation_x: { label: "Rotation X", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
    nacelle_grill_rotation_y: { label: "Rotation Y", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
    nacelle_grill_rotation_z: { label: "Rotation Z", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
  },
  "Pylons (Upper)": {
  ...
  "Warp Grills (Lower)": {
    ...
    nacelleLower_grill_length_scale: { label: "Length", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelleLower_grill_width_scale: { label: "Width", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelleLower_grill_depth_scale: { label: "Depth", min: 0, max: 2, step: 0.01, type: 'slider' },
    nacelleLower_grill_borderRadius: { label: "Border Radius", min: 0, max: 0.5, step: 0.01, type: 'slider' },
    nacelleLower_grill_y_offset: { label: "Fore/Aft Offset", min: -10, max: 10, step: 0.1, type: 'slider' },
    nacelleLower_grill_z_offset: { label: "Vertical Offset", min: -5, max: 5, step: 0.1, type: 'slider' },
    nacelleLower_grill_spread_offset: { label: "Spread Offset", min: -5, max: 5, step: 0.1, type: 'slider' },
    nacelleLower_grill_rotation_x: { label: "Rotation X", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
    nacelleLower_grill_rotation_y: { label: "Rotation Y", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
    nacelleLower_grill_rotation_z: { label: "Rotation Z", min: -Math.PI, max: Math.PI, step: 0.01, type: 'slider' },
  },
  "Lower Boom": {
