...
export const LIGHT_PARAM_CONFIG: ParamConfigGroups = {
    ...
    "Nebula Background": {
        ...
        nebula_density: { label: "Cloud Density", min: 0.1, max: 8, step: 0.01, type: 'slider' },
        ...
        nebula_stars_count: { label: "Star Count", min: 0, max: 15000, step: 100, type: 'slider' },
        nebula_stars_intensity: { label: "Star Brightness", min: 0, max: 12, step: 0.01, type: 'slider' },
...
export const PARAM_CONFIG: ParamConfigGroups = {
  ...
  "Pylons (Upper)": {
    ...
    pylon_nacelleVerticalOffset: { label: "Nacelle Vertical Offset", min: -10, max: 10, step: 0.1, type: 'slider' },
  ...
  "Pylons (Lower)": {
    ...
    pylonLower_nacelleVerticalOffset: { label: "Nacelle Vertical Offset", min: -10, max: 10, step: 0.1, type: 'slider' },
