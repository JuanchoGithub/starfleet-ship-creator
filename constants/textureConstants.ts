...
export const TEXTURE_PARAM_CONFIG: ParamConfigGroups = {
  ...
  "Engineering Hull Texturing": {
    ...
    "Registry Text": {
        ...
        engineering_texture_registry_rotation: { label: "Rotation", min: -90, max: 90, step: 1, type: 'slider' },
    },
    "Pennant & Delta": {
  ...
  "Saucer Texturing": {
    ...
    "Ship Name Text": {
        ...
        saucer_texture_name_toggle: { label: "Enable Name", type: 'toggle' },
        ...
        saucer_texture_name_curve: { label: "Curvature", min: 0, max: 20, step: 0.1, type: 'slider' },
    ...
    "Registry Text": {
        saucer_texture_registry_toggle: { label: "Enable Registry", type: 'toggle' },
        ...
        saucer_texture_registry_curve: { label: "Curvature", min: 0, max: 20, step: 0.1, type: 'slider' },
